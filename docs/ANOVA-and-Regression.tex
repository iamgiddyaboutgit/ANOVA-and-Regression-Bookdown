...
Let's look at this experiment to see the SS Decomposition in action.
...
\[\text{SS}_{\text{total}} = \sum_{i=1}^{k} \sum_{j = 1}^{n_i} \left( y_{ij} - \bar{\bar{y}} \right)^2 = 2103.733\]

\[\text{SS}_{\text{within}} = \sum_{i=1}^{k} \sum_{j = 1}^{n_i} \left(y_{ij} - \bar{y}_{i \cdot} \right)^2 = 330.102\]

\[\text{SS}_{\text{between}} = \sum_{i=1}^{k} n_i\left( \bar{y}_{i \cdot} - \bar{\bar{y}} \right)^2 = 1773.631\]
...
## -5.498 -2.304  0.080  2.374  7.442 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)    8.162      1.050   7.770 3.70e-07 ***
## group         12.426      1.486   8.365 1.29e-07 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.322 on 18 degrees of freedom
## Multiple R-squared:  0.7954, Adjusted R-squared:  0.784 
## F-statistic: 69.97 on 1 and 18 DF,  p-value: 1.291e-07
\end{verbatim}
...
## group        1  772.0     772   69.97 1.29e-07 ***
## Residuals   18  198.6      11                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
...
## t = 8.3648, df = 18, p-value = 1.291e-07
