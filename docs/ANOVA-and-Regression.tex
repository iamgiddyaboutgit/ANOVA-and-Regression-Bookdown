...
\begin{equation}
\label{eqn:EVE2}
\mathrm{Var}(Y_{ij}) = \underbrace{\mathrm{E}[\mathrm{Var}(Y_{ij}|A_i)]}_{\substack{\text{variance of } Y \\ \text{within groups}}} + \underbrace{\mathrm{Var}[\mathrm{E}(Y_{ij}|A_i)]}_{\substack{\text{variance of } Y \\ \text{between groups}}}
\end{equation}
...
\begin{equation}
\label{eqn:EVE2.1}
\mathrm{E}(Y_{ij}|A_i) = \sum_{j = 1}^{n_i} y_{ij} \frac{1}{n_i} = \bar{y}_{i \cdot}
\end{equation}

\begin{equation}
\label{eqn:EVE2.2}
\mathrm{Var}(Y_{ij}|A_i) = \sum_{j = 1}^{n_i} \left(y_{ij} - \bar{y}_{i \cdot} \right)^2 \frac{1}{n_i}
\end{equation}
...
\begin{verbatim}
## [1] "The population variance of Y is 4.08837570328874"
## [1] "The population variance of Y within X is 1.01360442688087"
## [1] "The population variance of Y between X is 3.07477127640787"
## [1] "The variance of Y = the variance of Y within X + the variance of Y between X (4.088 = 1.014 + 3.075)"
\end{verbatim}
...
## -6.413 -2.943  1.656  2.686  5.906 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   84.003      1.184  70.956  < 2e-16 ***
## group          6.721      1.674   4.014 0.000813 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.744 on 18 degrees of freedom
## Multiple R-squared:  0.4724, Adjusted R-squared:  0.4431 
## F-statistic: 16.11 on 1 and 18 DF,  p-value: 0.0008134
\end{verbatim}
...
## group        1  225.9  225.86   16.11 0.000813 ***
## Residuals   18  252.3   14.02                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
...
## t = 4.0143, df = 18, p-value = 0.0008134
