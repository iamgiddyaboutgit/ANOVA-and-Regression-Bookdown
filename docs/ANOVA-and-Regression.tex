...
{\centering \includegraphics[width=0.8\linewidth]{ANOVA-and-Regression_files/figure-latex/nice-fig-1} 
...
The law of total variance, also known as EVE's law \autocite{EVE}\autocite{EVE-intuition}, is very important for understanding how ANOVA works. The law says that for random variables \(X\) and \(Y\) we have
...
In the context of ANOVA, we will have a random response variable \(Y\) and a random variable \(G\) which indicates the number of the group that we are talking about. Using this notation, \ref{eqn:EVE} can be interpreted as

\begin{equation}
\label{eqn:EVE2}
\mathrm{Var}(Y) = \underbrace{\mathrm{E}[\mathrm{Var}(Y|G)]}_{\substack{\text{variance of } Y \\ \text{within groups}}} + \underbrace{\mathrm{Var}[\mathrm{E}(Y|G)]}_{\substack{\text{variance of } Y \\ \text{between groups}}}
\end{equation}
...
Suppose that we have a random response variable \(Y_{ij}\) where the subscript indicates that we have observed this \(j^{th}\) response for the \(i^{th}\) group. Then \ref{eqn:EVE2} can be rewritten using the definitions of the mean and variance of a population as

\begin{equation}
\label{eqn:EVE3}
\frac{1}{N} \sum_{i=1}^{k} \sum_{j = 1}^{n_i} \left(y_{ij}-\bar{\bar{y}} \right) = \frac{1}{N} \sum_{i=1}^{k} \sum_{j = 1}^{n_i} \left(y_{ij}-\bar{y}_{i\cdot} \right) + \sum_{i = 1}^{k} \frac{n_i}{N}\left(\bar{y}_{i\cdot} - \bar{\bar{y}} \right)^2 
\end{equation}

It is easy to see that both sides of \ref{eqn:EVE3} can be multiplied by \(N\) to give a relationship among sums of squares. The resulting relationship is known as a partition of the sum of squares. \autocite{partition_of_SS}
...
\includegraphics{ANOVA-and-Regression_files/figure-latex/unnamed-chunk-1-1.pdf}

\begin{verbatim}
## [1] "The population variance of Y is 3.90430033001671"
## [1] "The population variance of Y within X is 1.02394306625671"
## [1] "The population variance of Y between X is 2.88035726376"
## [1] "The variance of Y = the variance of Y within X + the variance of Y between X (3.904 = 1.024 + 2.88)"
\end{verbatim}
...
\includegraphics{ANOVA-and-Regression_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\includegraphics{ANOVA-and-Regression_files/figure-latex/unnamed-chunk-4-2.pdf}
...
\includegraphics{ANOVA-and-Regression_files/figure-latex/unnamed-chunk-11-1.pdf}
...
## -3.791 -1.318 -0.171  1.613  4.469 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  13.4210     0.7432  18.059 5.57e-13 ***
## group        -3.9340     1.0510  -3.743  0.00149 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.35 on 18 degrees of freedom
## Multiple R-squared:  0.4377, Adjusted R-squared:  0.4064 
## F-statistic: 14.01 on 1 and 18 DF,  p-value: 0.001489
\end{verbatim}
...
## group        1  77.38   77.38   14.01 0.00149 **
## Residuals   18  99.41    5.52                   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
...
## t = -3.7431, df = 18, p-value = 0.001489
