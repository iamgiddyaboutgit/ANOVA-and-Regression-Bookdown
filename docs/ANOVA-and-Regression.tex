...
\[\text{SS}_{\text{total}} = \sum_{i=1}^{k} \sum_{j = 1}^{n_i} \left( y_{ij} - \bar{\bar{y}} \right)^2 = 739.971\]

\[\text{SS}_{\text{within}} = \sum_{i=1}^{k} \sum_{j = 1}^{n_i} \left(y_{ij} - \bar{y}_{i \cdot} \right)^2 = 558.06\]

\[\text{SS}_{\text{between}} = \sum_{i=1}^{k} n_i\left( \bar{y}_{i \cdot} - \bar{\bar{y}} \right)^2 = 181.911\]

Notice that \(\text{SS}_{\text{total}} = \text{SS}_{\text{within}} + \text{SS}_{\text{between}}\). Also, \(\frac{\text{SS}_{\text{total}}}{n - 1} = s^2 = 13.962\).

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(}\FunctionTok{aov}\NormalTok{(response }\SpecialCharTok{\textasciitilde{}}\NormalTok{ trt, }\AttributeTok{data =}\NormalTok{ fabricated\_data))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##             Df Sum Sq Mean Sq F value  Pr(>F)   
## trt          4  181.9   45.48   3.993 0.00699 **
## Residuals   49  558.1   11.39                   
## ---
...
## -7.101 -3.132 -0.201  2.769  5.739 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   83.012      1.202  69.041  < 2e-16 ***
## group         -8.151      1.700  -4.794 0.000145 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.802 on 18 degrees of freedom
## Multiple R-squared:  0.5607, Adjusted R-squared:  0.5363 
## F-statistic: 22.98 on 1 and 18 DF,  p-value: 0.0001454
\end{verbatim}
...
\begin{verbatim}
##             Df Sum Sq Mean Sq F value   Pr(>F)    
## group        1  332.2   332.2   22.98 0.000145 ***
## Residuals   18  260.2    14.5                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
...
## t = -4.7936, df = 18, p-value = 0.0001454
