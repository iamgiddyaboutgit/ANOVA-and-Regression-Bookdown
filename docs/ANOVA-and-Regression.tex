...
where the summation is known as a sum of squares (SS). It is easy to see that both sides of \ref{eqn:EVE2} can be multiplied by \(N\) to give a relationship among sums of squares. The resulting relationship is known as a partition of the sum of squares. \autocite{partition_of_SS}
...
\includegraphics{ANOVA-and-Regression_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\includegraphics{ANOVA-and-Regression_files/figure-latex/unnamed-chunk-3-2.pdf}
...
\includegraphics{ANOVA-and-Regression_files/figure-latex/unnamed-chunk-10-1.pdf}
